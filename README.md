...
OpenRPG currently has a Rust core with module boot, JSON content packs, entity/component storage, command execution, events, patches, deterministic RNG, world values, snapshots, stat blocks, resource pools, stackable inventories, and equipment slots. More RPG systems are coming next.
